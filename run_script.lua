--[[
    ========================================================================
    [  PREMIUM PREMIUM MULTI-FUNCTION BYPASS HUB v3.3 (CLEAN EDITION)  ]
    ========================================================================
...
--[[
    ========================================================================
    [  PREMIUM MULTI-FUNCTION BYPASS HUB v3.3 (CLEAN EDITION)  ]
    ========================================================================
...
local TitleBar = create("TextLabel", MainFrame, {
    ...
    BackgroundTransparency = 1, 
    Text = "  PREMIUM SCRIPT BYPASS HUB [V3.3 รุ่นพิเศษ]", 
